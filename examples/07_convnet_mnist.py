...
CHECKPOINT_DIR = 'checkpoints/convnet_mnist_new/checkpoint/'
try:
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./my_graph/mnist/convnet/', sess.graph)
    ...
    for index in range(initial_step, n_batches * N_EPOCHS): # train the model n_epochs times
        ...
        if (index + 1) % SKIP_STEP == 0:
            ...
            total_loss = 0.0
            saver.save(sess, save_path=CHECKPOINT_DIR, global_step=index)
