...
with tf.variable_scope('conv1') as scope:
    ...
    biases = tf.get_variable('biases', [32], initializer=tf.constant_initializer())
...
utils.make_dir('/Users/sirius/Downloads/checkpoints')
utils.make_dir('/Users/sirius/Downloads/checkpoints/convnet_mnist')
...
with tf.Session() as sess:
    ...
    ckpt = tf.train.get_checkpoint_state(os.path.dirname('/Users/sirius/Downloads/checkpoints/convnet_mnist/checkpoint'))
    ...
    for index in range(initial_step, n_batches * N_EPOCHS): # train the model n_epochs times
        ...
        if (index + 1) % SKIP_STEP == 0:
            ...
            total_loss = 0.0
            saver.save(sess, '/Users/sirius/Downloads/checkpoints/convnet_mnist/mnist-convnet', index)
